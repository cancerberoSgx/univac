...
//       $._octal_integer_literal,
//       $._binary_integer_literal,
//       $._long_integer_literal
//     ),

//     _decimal_integer_literal: $ => DIGITS,

//     _hex_integer_literal: $ => token(seq(
//         choice('0x', '0X'),          
//     )),

//     _octal_integer_literal: $ => token(seq(
//       choice('0o', '0O'),
//       sep1(/[0-7]+/, '_')
//       )),

//     _binary_integer_literal: $ => token(seq(
//       choice('0b', '0B'),
//       sep1(/[01]+/, '_')
//     )),

//     _long_integer_literal: $ => token(seq(
//       sep1(/[0-9]+/, '_'),
//       choice('l', 'L'),
//     )),

//     _floating_point_literal: $ => choice(
//       $._decimal_floating_point_literal,
//       $._hex_floating_point_literal
//     ),

//     _decimal_floating_point_literal: $ => token(
//       choice(
...
//     _hex_floating_point_literal: $ => token(seq(
//       choice('0x', '0X'),
//       choice(
